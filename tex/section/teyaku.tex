...
立体図 \ref{rittai:yakuhai-10} は頭不安定の牌姿。他の部分に愚形がないので自風の \mj{4z} の価値は高くない。\mj{4z} と \mj{9s} の比較は安全度の比較となる。今回の場況はソーズの上がたくさん切られている分で、生牌の \mj{4z} と \mj{9s} の安全度がほぼ同じ。NAGAは50/50。場況を変えてソーズが切られていないのにすると \mj{9s} が危険になって、NAGAの選択 \mj{9s} 切りになる\footnote{著者の実戦から。\href{https://naga.dmv.nico/htmls/b1ce439d70b8dfc48152e539f75e29d57763308a9de1dfafc95f65a9529f2757v2_2.html?tw=2}{NAGAのシミュレーション}。}。

\begin{rittai}[h]
  \centering
  \drawrittai{
    jicha/seat = 北,
    jicha/hand = 2346m 278p 34559s 4z -3p,
    jicha/river = 7z,
    jicha/point = 23500,
    %
    toimen/river = 3z 9^s 2z,
    toimen/point = 26100,
    %
    kami/river = 7z 8s,
    kami/point = 21300,
    %
    kami/hand = XXXXXXXXXX -55'5z,
    shimo/river = 9s 7z 7^s,
    shimo/point = 28100,
    %
    kyoku = 東4局,
    honba = 1,
  ...
  \caption{場に安い \mj{9s} と生牌の自風 \mj{4z} の二択}
  \label{rittai:yakuhai-10}
\end{rittai}

立体図 \ref{rittai:yakuhai-11} は両面もない面子もない聴牌まで遠い牌姿。配牌が悪いので守備気味で \mj{2s} を第一打として打って、裏目の \mj{3s} を引いても振聴になりうるのでNAGAは \mj{6z} を残すことにした\footnote{著者の実戦から。\href{https://naga.dmv.nico/htmls/b1ce439d70b8dfc48152e539f75e29d57763308a9de1dfafc95f65a9529f2757v2_2.html?tw=2}{NAGAのシミュレーション}。}。

\begin{rittai}[h]
  \centering
  \drawrittai{
    jicha/seat = 西,
    jicha/hand = 24468m 1157p 9s 44z -3s,
    jicha/river = 2s 5z,
    jicha/point = 22900,
    %
    toimen/river = 2z 5z 1z,
    toimen/point = 25500,
    %
    kami/river = 3z 1^z 5^z,
    kami/point = 24600,
    %
    shimo/river = 9m 4z,
    shimo/point = 27000,
  ...
  \caption{}
  \label{rittai:yakuhai-11}
\end{rittai}

手牌~\ref{mj:yakuhai-12} はカンタンの \mj{1p} とダブ \mj{2z} の二択。両面対子が二つあるので、カンタンの強さが低くなる。よって、NAGAは打 \mj{1p} とした。ちなみにダブ \mj{2z} を \mj{6z} に変えたらNAGAが50/50になった\footnote{著者の実戦から。\href{https://naga.dmv.nico/htmls/b1ce439d70b8dfc48152e539f75e29d57763308a9de1dfafc95f65a9529f2757v2_2.html?tw=2}{NAGAのシミュレーション}。\href{https://naga.dmv.nico/htmls/af150475d0e819f2f3ef9517b0008a6d4539d560b39615e4786de788c87c4aeav2_2.html?tw=2}{ダブ \mj{2z} ではなく \mj{6z} の場合}。}。

\tehai{479m 1333p 344788s 2z}[南2局　南家　3巡目　ドラ \mj{5z}][yakuhai-12]

手牌~\ref{mj:yakuhai-13} は面子なし両面もなしの牌姿。124の1を切っても受け入れのロスにならないが、ここで注目したいのは123の三色。\mj{1p} が切れないなら、打牌候補は役牌の \mj{56z} と孤立の \mj{8m} となる。実際、Mortalは \mj{1s8m6z} の中に迷っていて、NAGAのニシキは \mj{1p} にしたがっていて、カガシは \mj{8m} にしたがっている\footnote{著者の実戦から。\href{https://naga.dmv.nico/htmls/d74ee2fcc180f30ce1bccb109223ac1827c57371d858de5d304b683696beabcfv2_2.html?tw=2}{NAGAのシミュレーション}。}。

\tehai{138m 124p 122455s 56z}[東1局　西家　3巡目　ドラ \mj{4s}][yakuhai-13]


\subsubsection*{オタ風より数牌を先に切る場面}

19の牌の筋（47）が孤立牌の場合、オタ風より切ってもいい。AIの癖ではないかがわからないが、少なくともそういう傾向がある。もっとサンプルが必要。

手牌~\ref{mj:ota-over-suupai-1} はドラなしの4向聴の配牌。MortalとNAGAは打 \mj{34z} ではなくて打 \mj{1s} とした。受け入れから見ると \mj{1s} の受け入れが \mj{4s} と被られていて、\mj{34z} と同じ切っても縦引きの3枚損。オタ風は他家にポンされる可能性がゼロではないが、ポンされて安くに済ませても構わないほど悪い手牌なら、オタ風の処理を後回しても悪くないかと\footnote{著者の実戦から。\href{https://naga.dmv.nico/htmls/5cf8b09858eeb46bf58f9b8facf3d22bef7ac1a019f837024cfc8ce7e6c1c90cv2_2.html?tw=2}{NAGAのシミュレーション}。}。

\tehai{5799m 2357p 149s 134z}[東2局　南家　1巡目　ドラ \mj{6z}][ota-over-suupai-1]


\subsubsection*{役牌アタック}

「役牌アタック」というのは、他家が役牌を重ねる前に、もしくは手牌がまた不安定の状態の中で、オタ風の先に役牌を切るという戦術 \citep[][pp.~16--17]{zero-teyaku}。役牌が先に出ていくのは、自分の手牌が相当に整っている、もしくは役牌の価値が手組みに対する価値が低い。つまり、
...
手牌 \ref{mj:yakuhai-attack-3} は微妙な牌姿。前述した条件は該当しないので、門前に近いとは思えないが、頭もないのでオタ風も役牌も価値が高くない。NAGAのヘビたちの中にも意見が割れている\footnote{\href{https://naga.dmv.nico/htmls/b1ce439d70b8dfc48152e539f75e29d57763308a9de1dfafc95f65a9529f2757v2_2.html?tw=2}{NAGAのシミュレーション}}。

\tehai{124678m 256p 468s 36z}[東2局　南家　1巡目　ドラ \mj{2m}][yakuhai-attack-3]
...
\subsubsection*{オーラスでタンヤオを狙う}

下記の手牌は全てオーラスでトップ目と500点差だと仮定している。

手牌 \ref{mj:tanyao-force-1} は愚形ばかりで門前から遠い。まずはタンヤオを目指して一番不要な \mj{89m} 辺張搭子を払う。\mj{9m} を落とした後で \mj{678m} のどちらを引いたら \mj{9p} を落とす。鳴ける牌は \mj{368p257s} だが、\mj{6p} チーの場合は \mj{9p} は切られなくて打 \mj{8p} とする \citep[][pp.~11--12]{kawamura-naki}。

\tehai{489m 247889p 22468s}[西家　1巡目　ドラ \mj{3z}][tanyao-force-1]

手牌 \ref{mj:tanyao-force-2} も嵌張三つなので門前はない。この手牌はタンヤオだけではなく、\mj{567z} のどちらかが重ねると役牌もある。こう見ると \mj{4z} は一番不要。対子にも関わらず \mj{4z} を落とす。手牌 \ref{mj:tanyao-force-3} に両面二つあっても同じタンヤオか役牌を狙う \citep[][pp.~27--28]{kawamura-naki}。

\tehai{2488m 358p 46s 44567z}[南家　1巡目　ドラ \mj{3z}][tanyao-force-2]

\tehai{3488m 568p 46s 44567z}[南家　1巡目　ドラ \mj{3z}][tanyao-force-3]

手牌 \ref{mj:tanyao-force-4} は234三色も見える。三色を狙いにいくと \mj{44z} は必要になり、\mj{8p567z} が不要になる。だとすると \mj{567z} から落とし、タンヤオと三色の可能性を保ちつつ進む。\mj{8p} の周囲に有効牌が引けないなら \mj{4z} ポンして三色を狙う。

\tehai{2488m 348p 24s 44567z}[南家　1巡目　ドラ \mj{3z}][tanyao-force-4]

手牌 \ref{mj:tanyao-force-5} には辺張が二つある。それでもトップを取るためにタンヤオを狙い、\mj{1m9p} を立て続けに切る。么九牌を切った後振聴搭子を解消しやすさで辺張を比較すると、\mj{1m} は最初に切る。\mj{3m} を引いた後 \mj{2m} 引きで対子＋嵌張や、\mj{4m} チーで振聴両面を解消できるから。一方、\mj{9p} を切って \mj{8p} を引いたら \mj{7p} チーしか解消できない \citep[][pp.~53--54]{kawamura-naki}。

\tehai{12578m 24688s 2489p}[子　1巡目　ドラ \mj{3z}][tanyao-force-5]


\subsubsection*{オーラスでタンヤオも門前も近いケース}

下記の手牌は全てオーラスでトップ目と500点差だと仮定している。

手牌 \ref{mj:tanyao-menzen-close-1} は両向聴で、門前立直は近そう。平場なら門前で行くが、オーラスのアガリトップならタンヤオを狙いに行く。それに、 \mj{2s8p} の対子があってポンしやすい。打 \mj{1m} とする \citep[][pp.~41--42]{kawamura-naki}。

\tehai{123457m 56688p 224s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-1]

手牌 \ref{mj:tanyao-menzen-close-2} は打 \mj{7m} とすると完全一向聴になる。早い巡目で打 \mj{7m} とするのはよしとする。

\tehai{123457m 22678p 667s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-2]

手牌 \ref{mj:tanyao-menzen-close-3} は \mj{1p} 対子を払ったらタンヤオが確定されているが、\mj{178p} 8枚の受け入れもなくなる。打 \mj{5s} とすると\mj{36m1578p} 20枚を受けている一向聴に構える上に、\mj{6m5p} チーして \mj{1p} を落とすと456三色も見える。よって、タンヤオを狙わず打 \mj{5s} とする \citep[][pp.~43--44]{kawamura-naki}。

\tehai{45m 11234688p 4556s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-3]

手牌 \ref{mj:tanyao-menzen-close-4} も同じ、\mj{1p} を切ったら \mj{6m5s} が遊び牌になって、向聴数も増える。\mj{5s} を切ったら受け入れが16枚になる。\mj{6m} にしたら4枚損だが、\mj{3467s} チーや引きで \mj{1p} を払ってタンヤオに構える。よって、ここは打 \mj{6m} とする。これは \ref{mj:tanyao-4} と似ているケース \citep[][pp.~43--44]{kawamura-naki}。

\tehai{34688m 11234p 4556s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-4]

手牌 \ref{mj:tanyao-menzen-close-5} に対子が四つあって、門前両向聴だが七対子一向聴。七対子は門前限定なので、仕掛けるためにタンヤオは優先。七対子を否定しないように打 \mj{9m} とする。\mj{2m2s} 切りも七対子を否定しないが、タンヤオから遠くなってしまう \citep[][pp.~57--58]{kawamura-naki}。

\tehai{247889m 2277p 2488s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-5]

手牌 \ref{mj:tanyao-menzen-close-6} に尖張牌の対子が三つある。\mj{9p} を切ったらタンヤオが行けそうが、実は仕掛けづらい。よって、この手牌は牌効率の通りに \mj{5s} を切る。345三色を見落とさないように \citep[][pp.~59--60]{kawamura-naki}。

\tehai{355m 357789p 22455s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-6]

手牌 \ref{mj:tanyao-menzen-close-7} も対子が全て中張牌。\mj{9p} を落としても \mj{778p} の受け入れは \mj{45p} と被っている。よって、牌効率の通りに打 \mj{7p} とする \citep[][pp.~59--60]{kawamura-naki}。

\tehai{34577m 457789p 468s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-7]

手牌 \ref{mj:tanyao-menzen-close-8} の場合対子は28になるとタンヤオは狙いやすくなる。打 \mj{9p} とする \citep[][pp.~59--60]{kawamura-naki}。

\tehai{34588m 347889p 468s}[子　1巡目　ドラ \mj{3z}][tanyao-menzen-close-8]


\subsubsection*{タンヤオ移行の準備}

7巡目以前、もしくは他家から仕掛けが入っていない状況、\mj{23m} のようなタンヤオのネックが一つだけなら、常にタンヤオ搭子を作る孤立牌を意識する \citep[][pp.~155--158]{kawamura-naki}。アガリトップやドラ3の場合なら仕掛けるために。手牌 \ref{mj:tanyao-9} を見ると、\mj{2367m} 引きで完全一向聴になるだけではなく、\mj{3p} -- \mj{8p3s} \mj{8s} のどちらを引いたらタンヤオへの移行ができる。仮に \mj{3p} を引いて \ref{mj:tanyao-9a} になったら、\mj{4p} チーして \mj{3m} を落とす。\mj{3s} 引きで \ref{mj:tanyao-9b} になっても \mj{4s} チーしてタンヤオへ移行できる。
...
手牌にはドラがないならタンヤオによる打点上昇がリスクに見合わない。手牌 \ref{mj:tanyao-9c} はアガリトップ以外の場合は \mj{2367m7p} しか手牌に入れない。

\tehai{2367m 23477p 567s 3z}[ドラ \mj{4z}][tanyao-9c]

手牌 \ref{mj:tanyao-10a} に \mj{78s} のネックがある。\mj{4s} の辺を引いたらタンヤオや三色が見える。\ref{mj:tanyao-10b} ならタンヤオドラ2は既に確定されているので、三色による打点も必要ではない。よって、\ref{mj:tanyao-10a} は打 \mj{3z}、\ref{mj:tanyao-10b} は打 \mj{4s} とする。

\tehai{23467m 23455p 478s 3z}[ドラ \mj{5p}][tanyao-10a]

\tehai{23467m 23455p 467s 3z}[ドラ \mj{5p}][tanyao-10b]

前の小節で \mj{7799m} の飛び対子から \mj{9m} を落としてタンヤオを見るのを習った。手牌 \ref{mj:tanyao-11a} から \ref{mj:tanyao-11c} までは 飛び対子と孤立牌の比較。牌効率の通りなら打 \mj{7s} の方が一番広い。一見打 \mj{7s} としても \mj{6s} の受けは消えないが、\mj{123457s} から \mj{6s} チーしたら \mj{1s} を落としてタンヤオへ移行できる。

\textbf{手牌の価値は3900（または3900になりそう）ならタンヤオのために打} \mj{9m} \textbf{とする} \citep[][pp.~165--170]{kawamura-naki}。手牌 \ref{mj:tanyao-11a} にドラが2枚あって既に3900なので打 \mj{9m} とする。\ref{mj:tanyao-11b} にドラが1枚だけあるが、\mj{45m} 両面がドラ \mj{6m} や赤 \mj{0p} を受けるので3900になりうる。\ref{mj:tanyao-11c} なら \mj{3z} を受けないので3900にならない。3900にならないなら素直に \mj{7s} を切って門前で行く。

\tehai{457799m 34p 123457s}[ドラ \mj{7m}][tanyao-11a]

\tehai{457799m 34p 123407s}[ドラ \mj{6m}][tanyao-11b]

\tehai{457799m 34p 123407s}[ドラ \mj{3z}][tanyao-11c]

手牌 \ref{mj:tanyao-chance-1} は \mj{34568m4567p} 引きで完全一向聴や暗刻含みヘッドレス一向聴。その他、\mj{23p} 引きはポンできてタンヤオへ移行できる。平場なら \mj{23p} は不要だが、アガリトップやドラ3なら \mj{23p} より \mj{4z} を先に切る \citep[][pp.~17--18]{kawamura-naki}。

\tehai{4588m 12356p 234s 4z}[ドラ \mj{3z}][tanyao-chance-1]


\subsubsection*{タンヤオとダブ東の決断}

\textbf{門前ならダブ東を見切る}\citep[][pp.~138--139]{fkt}。手牌~\ref{mj:tanyao-12} はダブ東のために両面搭子を払うのは見合わない。立直・タンヤオ・ドラの方でツモや裏ドラなどで12000になる可能性があるから。

\tehai{22456m 22240p 67s 11z}[東場　東家　6巡目　ドラ \mj{3z}][tanyao-12]

\textbf{仕掛けが入ったらダブ東で12000を目指す}\citep[][pp.~140--141]{fkt}。手牌~\ref{mj:tanyao-13} は立直や裏ドラなどがないため、両面両面で行くと2900や都合よくて赤ドラ引いて5800。一方、\mj{1z} を鳴いたら打点が2900から11600になるので段違いです。

\tehai{22456m 40p 67s 11z -6'66z}[東場　東家　6巡目　ドラ \mj{3z}][tanyao-13]

手牌~\ref{mj:tanyao-14} のようなダブ東バックでもクイタンよりいい。打点から見ても \mj{1z} の安全度と連打できることから見ても。場況によって打 \mj{3p} でも打 \mj{67s} でもあり\citep[][pp.~143--144, p.~218]{fkt}。

\tehai{22456m 30p 67s 11z -2'22pz}[東場　東家　6巡目　ドラ \mj{3z}][tanyao-14]


\subsubsection*{タンヤオと役牌の決断}

\textbf{両面両面またはドラ3以外なら役牌対子にする} \citep[][pp.~177--180]{kawamura-naki}。手牌~\ref{mj:tanyao-15a} から \ref{mj:tanyao-15c} までは全て7巡目で \mj{7s} をチーした直後、\mj{7z} を落としてタンヤオにするか他の搭子を落として役牌に頼るかと迷っている場面。こんなに遅くて \mj{7z} はもちもちで、落とさないとこの手牌はもうアガれない、と思う人がいるかもしれないが、本当にもちもちなら \mj{7z} を落とすとポンされてしまうではないでしょうか。それは明らかに矛盾。

だからこそ \mj{7z} 落としのメリットはほぼない。もちもちなら \mj{7z} は他家に拾わせて、もちもちでなくても守備力は落ちる。打 \mj{7z} にする場合は手牌は平均よりいい場面、つまり両面両面やドラ3で早く役を確定したい場面。手牌 \ref{mj:tanyao-15a} は打 \mj{6m}、\ref{mj:tanyao-15b} は打 \mj{7z}、\ref{mj:tanyao-15c} は打 \mj{7z} とする。

\tehai{23468m 56p 22s 77z -7'68s}[7巡目　ドラ \mj{3m}][tanyao-15a]

\tehai{23467m 56p 22s 77z -7'68s}[7巡目　ドラ \mj{3m}][tanyao-15b]

\tehai{23468m 06p 22s 77z -7'68s}[7巡目　ドラ \mj{2s}][tanyao-15c]
...
似たような牌姿だが、今回~\ref{mj:pinfu-2} にタンヤオが見込むので、タンヤオの優先度が安牌より高い。より危険な \mj{3m} を先切るのもあり。

\tehai{334678m 56p 22788s -3z}[東1局　西家　5巡目　ドラ \mj{8p}][pinfu-2]

手牌 \ref{mj:pinfu-3} からはどちらの両面を落とさないといけない。赤入りルールは25や58の両面は36や47より残したいので、ここは \mj{45s} を落とす。\mj{9m} がドラではないと、\mj{4s} から落とす。そうすると、\mj{0s} を引いて \mj{05s} の対子ができた場合 \mj{9m} と入れ替えできる。\mj{9m} がドラなら \mj{5s} から落とす。\mj{0s} を引いたら他の両面を落とす \citep[][pp.~13--14]{kawamura-naki}。

\tehai{3499m 12367p 45789s}[][pinfu-3]


\subsubsection*{ピンフと役牌の決断}

手牌 \ref{mj:pinfu-4} のような良形しかない牌姿は平場で \mj{7z} を落としてメンピンに向かう。アガリトップならピンフは存在しないもの。\mj{7z} を生かすために \mj{78m56p} を落としてポンテンに構える形にはなるが、\mj{69m47p} 16枚引きで即立直はできない。\mj{2s} がなくても \mj{78m56p} のどちらを引いたら完全一向聴になる。よって、ここは打 \mj{2s} とする \citep[][pp.~179--180]{kawamura-naki}。

\tehai{12378m 56p 22678s 77z}[ドラ \mj{3m}][pinfu-4]


%---------------------------------------------
\subsubsection{一盃口}

一盃口は中ぶくれや亜両面などの連続形から自然にできることが多くて、無理に狙う場面が少ない。\mj{33445p} のような両面＋面子の形でも半分の確率で一盃口が消える。\mj{33455p} のような一盃口が確定している形は、自分が待ちの牌をすでに1枚持っているので、もう場に1枚切れになると苦しくなる。両面より \mj{33455p} を先に処理する。2枚見えなら他の嵌張より先に切る\citep{gendai-ipk}。よって、手牌~\ref{mj:ipk-0} は \mj{79m} の嵌張を払う。リーのみになるが、両面リーのみならまだ許容範囲内\citep[][pp.~121--122]{ooi-gundou}。

\tehai{77899m 11166p 2378s}[北家　6巡目　ドラ \mj{8p}][ipk-0]
...
対子が内に寄ってタンヤオが確定されているなら三連対子の真ん中を抜く選択肢が浮上。手牌~\ref{mj:santobitt-3} のようなタンヤオが確定されている牌姿は期待値としても打 \mj{7s} で一盃口が狙える方が優位だが、アガリトップなどの打点不要な局面なら \mj{7s} の両面変化を見て打 \mj{4p} のもあり。\mj{224466p} の形でも \mj{22466p} の形でも \mj{5p} を引いたら両面対子にならないため\citep[][p.~117]{uzaku-haikouritsu}。
...
手牌 \ref{mj:honitsu-alllast} には役牌の対子がない。聴牌まで遠い手牌だが、アガリトップなら混一色やチャンタを狙う。まず \mj{6m} を落として \mj{2p} 以外は全て仕掛ける。\mj{2p} チーは \mj{9p} 引きでチャンタがもっと近い時にする \citep[][pp.~37--38]{kawamura-naki}。

\tehai{67m 13p 112279s 1445z}[アガリトップ　西家　1巡目　ドラ \mj{3z}][honitsu-alllast]
...
\tehai{6m 46p 14467s 336z -444'z}[東場　北家　1巡目　ドラ \mj{2m}][honitsu-13]
...
手牌~\ref{mj:ssk-13} には567の三色が確定しているが、三色のために嵌張を抱え続けるのは苦しいすぎる。タンヤオがあるので（平場なら）三色に拘る理由はない。牌効率の通りに打 \mj{5m} \citep{gendai-ssk}。
...
手牌 \ref{mj:ssk-24} から \mj{3p} を落とすと567と678の三色両天秤ができるが、\mj{4p} 引きでメンタンピンドラ1の満貫チャンスが逃がされる。ここまでの例は三色の2飜のために価値のない4枚の受け入れを犠牲するが、\ref{mj:ssk-24} の4枚の \mj{4p} は高いとも言える。よって、牌効率の通りに打 \mj{8m} か打 \mj{5m} かとする。\mj{067p} があって567の方が出来やすいので \mj{8m} を切る \citep{gendai-ssk}。
...
くっつき一向聴の中で、三色と一通の両天秤の牌姿は「黄金の一向聴」と呼ばれている。例え手牌~\ref{mj:golden-1} は打 \mj{6s} にすると、ツモ \mj{16p} で一通が見えて、ツモ \mj{79m} で789の三色が見える。打 \mj{8m} のピンフより価値が高いので、ここは打 \mj{9s} \citep{rb1}。
...
\tehai{334479m 22388s 777z}[ドラ \mj{1p}][chit-6]
...
手牌~\ref{mj:chit-9} は手なりなら打 \mj{8m}。面子手と七対子の両天秤にすると打 \mj{59s}。が、ここはまだ一段目なので、七対子一向聴の階段でアガリ率を最大化するため打 \mj{7s} の選択肢も浮上してくる\citep[][pp.~84--85]{zero-teyaku}。
...
手牌~\ref{mj:rst-6} は枯れている \mj{13s} を処理している際。\mj{30677s} の形にツモ \mj{8s} からの両面嵌張を備えるため \mj{1s} から落とす\footnote{作者が実戦で会ったケース}。

\tehai{11347p 112330677s}[東4局　西家　7巡目　ドラ \mj{5s}　\mj{2s} 2枚切れ][rst-6]
...
選択肢同士の受け入れに差が出ない場合、役で判断する。手牌~\ref{mj:ist-13} の場合、\mj{5s} を切って \mj{334455s} の一盃口になる可能性があるが打 \mj{3s} の受け入れと良形聴牌率で比べると不利なのでここで一盃口を見切って打 \mj{3s} とする。
...
配牌の中に三向聴のは一番多い。次いでは四向聴。この2種類の配牌の合計は75\%台になるといいつつも、ただ1局で四向聴以上の配牌しかこない超不運に突き込むときもある。三向聴の配牌のアガリ率は20\%くらいで、五向聴なら15\%くらいで、つまり7回の中に1回しかアガれない。そのほかの6回のために守備力を落とさずに、アガった1回の手牌の価値を高まるのはクソ悪配牌の進行方針。具体に言うと、
