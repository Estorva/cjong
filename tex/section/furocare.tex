...
\begin{rittai}[h]
  ...
  \drawrittai{
    jicha/seat = 西,
    jicha/hand = 1234567999p 557z,
    jicha/river = 13^5m 34s 6z,
    jicha/riverb = 2z 6^s,
    %
    toimen/hand = XXXXXXX -5'34m2'22s,
    toimen/river = 3z 1m 2p 6z 8^p 0^s,
    toimen/riverb = 1^p 0^p 5^z,
    %
    kami/river = 9s 211m 4^z 3s,
    kami/riverb = 6^z 4p,
    %
    shimo/river = 3z 1p 11^s 23m,
    %
    dora = 7z
  }
  
  \caption{親の \mj{5z} ポンするなら生牌のドラ \mj{7z} を切るか}
  \label{rittai:raw-dora}
\end{rittai}

立体図~\ref{rittai:raw-dora} で自分は混一色の一向聴。親が \mj{5z} をツモ切りして、ポンしたら \mj{7z} を切って \mj{1478p} の多面張を取るか、\mj{7z} を残して \mj{14p} のどっちを切るか、という二択。

親の河に赤ドラが切っている上、\mj{17z} もともに見えない。従って、親の手牌の中に \mj{17z} のダブルバックや役牌暗刻があっても怪しむに足りない。ここで \mj{4p} を切る\citep[][pp.116~119]{doi}。
