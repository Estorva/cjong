...
\textbf{両面＋両面の受けで鳴きにより打点が1/3になると中盤まで立直を狙う}\citep[][p.~33]{hirasawa-naki}、\textbf{鳴いても打点がそんなに下がらないなら中盤に入ると鳴く}\citep[][p.~38]{hirasawa-naki}。例え\ref{mj:naki-1}の場合、門前で行けばピンフがなくても少なくとも5200点がある。一方、\mj{2568p25s} で鳴いたらこの手牌の価値は2000点に過ぎない。よって、12巡目までは鳴かない（もちろん相手の速度や待ちの残り枚数で調整することもよくある）。
...
「後付け」とは、聴牌の時待ちの一部しか役ができない状態を指す。例えば、\mj{12'3p} の仕掛けが入って、自分の待ちは \mj{9p7z}、そして見えている役は役牌中しかない。この小節で \mj{12'3p} のような後付けに頼る仕掛けをすべきか否かを説明していく。

手牌\ref{mj:atozuke-1}からは \mj{9p} を鳴けてはいけない。ドラ3だが愚形だらけで一歩でも早く前に進みたいが、前に触られていてこの手を仕掛けると頭の候補が2種類減ってしまう。嵌張から鳴くのもありかなと\citep[][pp.~116--117]{fkt}。

\tehai{268m 3078p 1357s 66z}[子　2巡目　ドラ \mj{6z}][atozuke-1]
