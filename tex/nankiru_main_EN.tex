...
\begin{itemize}
  ...
  \item How much the value of our hand decreases (except for cases such as agaritoppu where value is irrelevant)
...
There are indeed cases where we only have an isolated \mj{789p} block and must sacrifice one safe tile for tanyao like \ref{mj:naki-tanyao-oorasu-3}. Chi \mj{6p} with \mj{78p} and drop \mj{3z} \citep{mark2-tanyao-naki}.
